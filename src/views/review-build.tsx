...
export default function ReviewBuildView() {
  ...
  return <main className="review-shell" style={{ maxHeight: maxHeight || undefined }} data-llm={llmContext}>
    ...
    <section className="review-viewport">
      <ReviewScene build={build} maxLayer={layerValue} hideRoof={hideRoof} cameraPreset={cameraPreset} cameraTarget={cameraTarget} cameraDistance={cameraDistance} orthographic={orthographic} selection={selection} annotations={annotations} texturePack={texturePack} onPick={onPick} />
