...
import { architecturalPlanOutputSchema, auditTotalsOutputSchema, buildAuditOutputSchema, buildCandidateOutputSchema, buildPreflightOutputSchema, buildSummaryOutputSchema, buildValidationOutputSchema, discoveredWorldOutputSchema, installWorldEditResultOutputSchema, outputBoundsSchema, paletteInterviewOutputSchema, resourcePackVersionOutputSchema, savedPaletteOutputSchema, } from "./lib/output-schemas.js";
...
const rolePaletteSchema = z.object(Object.fromEntries(paletteRoles.map((role) => [role, z.string().describe(`Namespaced Minecraft block identifier for the ${role} role.`)])));
