...
function decodedBase64ByteLength(base64) {
    if (!base64.length || base64.length % 4 !== 0)
        return -1;
    const padding = base64.endsWith("==") ? 2 : base64.endsWith("=") ? 1 : 0;
    return base64.length / 4 * 3 - padding;
}
export function resolveBedrockDownloadArtifact(output, metadata) {
...
export function createBedrockDownloadRequest(artifact) {
    return {
        contents: [
            {
                type: "resource",
...
export function releaseBedrockDownloadArtifact(reference) {
...
//# sourceMappingURL=bedrock-download.js.map